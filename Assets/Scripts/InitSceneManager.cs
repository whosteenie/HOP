...
public class InitSceneManager : MonoBehaviour {
    ...
    [SerializeField] private float initializationDelay = 0.1f; // Small delay to ensure all Awake/OnEnable calls complete
    ...
    [SerializeField] private GrappleUIManager grappleUIManager;
    ...
    private async void Start() {
        ...
        await UniTask.Delay(System.TimeSpan.FromSeconds(initializationDelay));
    ...
    private bool ValidateSingletons() {
        ...
        if(NetworkManager.Singleton == null) {
            Debug.LogWarning("[InitSceneManager] NetworkManager.Singleton is null (optional, but required for networking)");
        }
        
        if(GameMenuManager.Instance == null) {
            Debug.LogWarning("[InitSceneManager] GameMenuManager.Instance is null (optional)");
        }
        ...
        if(GrappleUIManager.Instance == null) {
            Debug.LogWarning("[InitSceneManager] GrappleUIManager.Instance is null (optional)");
        }

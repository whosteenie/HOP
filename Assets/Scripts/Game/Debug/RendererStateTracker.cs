        ...
        if(targetRenderer != null) {
            ...
            if(autoStartTracking) {
                ...
                UnityEngine.Debug.LogWarning(
                    $"[RendererStateTracker] Started tracking renderer on {gameObject.name} - initial enabled: {_lastEnabledState}, active: {_lastActiveState}, activeInHierarchy: {_lastActiveInHierarchyState}");
            }
        } else {

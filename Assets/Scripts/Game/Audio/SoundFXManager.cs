    ...
    public class SoundFXManager : MonoBehaviour {
        ...
        public void PlayKey(SfxKey key, Transform parent, Vector3 worldPos, bool allowOverlap) {
            ...
            if(parent != null) {
                ...
                (srcTransform = src.transform).SetParent(parent, false);
                srcTransform.localPosition = Vector3.zero;
            } else {
                Transform srcTransform;
                (srcTransform = src.transform).SetParent(transform, false);
                srcTransform.position = worldPos;
            }

...
namespace Game.UI.Screens {
    ...
    internal sealed class ScoreboardTopBar {
        ...
        public ScoreboardTopBar(Label matchTimerLabel, VisualElement leftScoreContainer, VisualElement rightScoreContainer,
            ...
            if(matchTimer != null) {
                if(matchTimer.IsPreMatch) {
                    ...
                    if(preMatchSeconds <= 0)
                        preMatchSeconds = matchSettings != null ? matchSettings.GetPreMatchCountdownSeconds() : defaultPreMatchSeconds;
        ...
        public void UpdateScoreDisplay(ScoreboardPlayerRegistry registry, ScoreboardPlayerData playerData,
            ...
            if(_leftScoreContainer == null || _rightScoreContainer == null || _leftScoreValue == null || _rightScoreValue == null)
                return;
        ...
        private void UpdateTeamBasedScore(IReadOnlyCollection<PlayerController> allControllers, MatchSettingsManager matchSettings) {
        ...
        private void UpdateFfaScore(IReadOnlyCollection<PlayerController> allControllers, ScoreboardPlayerData playerData,
            MatchSettingsManager matchSettings, PlayerController localController) {
            if(allControllers == null) throw new ArgumentNullException(nameof(allControllers));
            ...
            if(isTagMode) {
                for(var i = 0; i < sortedPlayers.Count; i++) {
                    ...
                    nextScore = i == 0 ? (sortedPlayers.Count > 1 ? sortedPlayers[1].score : 0) : sortedPlayers[0].score;
                    foundNext = true;
                    break;
                }
            } else {

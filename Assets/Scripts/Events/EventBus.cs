...
namespace Events {
    ...
    public static class EventBus {
        ...
        private static readonly HashSet<Type> OptionalEvents = new() {
            ...
            typeof(PlayerHopballPickupRequestedEvent),
            typeof(PlayerHopballManualDropRequestedEvent),
            typeof(HopballPickupPromptRequestEvent),
            typeof(DisconnectFpVisualHideRequestedEvent),
            typeof(HopballHoldStateChangedEvent),
            typeof(HopballHeldTimeAwardedEvent),
            ...
            typeof(PlayerFpWeaponRefreshRequestedEvent),
            typeof(PlayerHillOccupancyChangedEvent),
            typeof(PlayerTeamChangedEvent),
            typeof(ObjectiveTeamScoresRequestedEvent),
            ...
            typeof(InitialTagDesignationRequestedEvent),
            typeof(PlayerKillProgressionEvent),
            typeof(PlayerDeathProgressionEvent),
            typeof(PlayerGrappleUsedProgressionEvent),
            typeof(PlayerWallRunChainProgressionEvent),
            typeof(PlayerDistanceTraveledProgressionEvent),
            typeof(PlayerAirtimeProgressionEvent),
            typeof(PlayerJumpPadUsedProgressionEvent),
            typeof(PlayerTimeTaggedProgressionEvent),
            typeof(PlayerTagRecordedProgressionEvent),
            ...
            typeof(HopballEnergyDepletedEvent),
            typeof(HopballRespawnRequestedEvent),
            ...
            typeof(MatchProgressionResolvedEvent),
            typeof(MatchKingTimeAwardedEvent),
            typeof(RequestShowPostMatchXpEvent),
            typeof(PodiumVisualsSnappedEvent),
            typeof(PostMatchPodiumPrepareRequestedEvent),
            typeof(PostMatchResetVelocityRequestedEvent),
            typeof(PostMatchTeleportRequestedEvent),
            typeof(PostMatchSnapVisualsRequestedEvent),
            typeof(PostMatchWorldModelVisibilityEvent),
            typeof(PostMatchGameplayCameraEvent),
            typeof(PostMatchControlLockRequestedEvent),
            typeof(PostMatchSniperOverlayDisableEvent),
            ...
            typeof(UpdateOutOfBoundsCountdownEvent),
            typeof(UpdateHopballInteractPromptEvent),
            typeof(SetSniperOverlayVisibilityEvent),
            typeof(ScoreboardVisibilityChangedEvent),
            typeof(RequestRespawnFadeTransitionEvent),
            typeof(RequestRespawnFadeInSignalEvent),
            typeof(RequestPostMatchBlackoutTransitionEvent),
            typeof(RequestPostMatchFadeInEvent),

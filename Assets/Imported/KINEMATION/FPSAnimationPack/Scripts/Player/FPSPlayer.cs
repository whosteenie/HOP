...
namespace KINEMATION.FPSAnimationPack.Scripts.Player
{
    ...
    public class FPSPlayer : MonoBehaviour
    {
        ...
        [SerializeField] private bool allowCharacterControllerMovement = true;
        ...
        public void SetCharacterControllerMovementEnabled(bool enabled)
        {
            allowCharacterControllerMovement = enabled;
        ...
        private void Update()
        {
            ...
            if (allowCharacterControllerMovement && _controller != null)
            {

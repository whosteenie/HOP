...
public static unsafe class NativeMethods {
    ...
    public struct GuildChannel {
        ...
        [DllImport(LibraryName,
                   ...
                   CallingConvention = CallingConvention.Cdecl)]
        public static extern Discord.Sdk.ChannelType Type(GuildChannel* self);
        [DllImport(LibraryName,
                   EntryPoint = "Discord_GuildChannel_SetType",
                   CallingConvention = CallingConvention.Cdecl)]
        public static extern void SetType(GuildChannel* self, Discord.Sdk.ChannelType value);
        [DllImport(LibraryName,
    ...
    public struct UserApplicationProfileHandle {
        ...
        [DllImport(LibraryName,
                   ...
                   CallingConvention = CallingConvention.Cdecl)]
        public static extern Discord.Sdk.ExternalIdentityProviderType ProviderType(
    ...
    public struct Client {
        ...
        public static extern void RegisterAuthorizeRequestCallback(
          Client* self,
          Discord.Sdk.NativeMethods.Client.AuthorizeRequestCallback callback,
          void* callback__userDataFree,
          void* callback__userData);
        [DllImport(LibraryName,
        ...
        public static extern void IsDiscordAppInstalled(
          Client* self,
          Discord.Sdk.NativeMethods.Client.IsDiscordAppInstalledCallback callback,
          void* callback__userDataFree,
          void* callback__userData);
        [DllImport(LibraryName,
...
public class GuildChannel : IDisposable {
    ...
    public void SetType(Discord.Sdk.ChannelType value) {
        if (disposed_ != 0) {
            throw new ObjectDisposedException(nameof(GuildChannel));
        }
        unsafe {
...
public class UserApplicationProfileHandle : IDisposable {
    ...
    /// </summary>
    public Discord.Sdk.ExternalIdentityProviderType ProviderType() {
        if (disposed_ != 0) {
            throw new ObjectDisposedException(nameof(UserApplicationProfileHandle));
        }
        unsafe {
            Discord.Sdk.ExternalIdentityProviderType __returnValue;
            fixed(NativeMethods.UserApplicationProfileHandle* self = &this.self) {
...
public class UserHandle : IDisposable {
    ...
    /// </summary>
    public Discord.Sdk.UserApplicationProfileHandle[] UserApplicationProfiles() {
        if (disposed_ != 0) {
            throw new ObjectDisposedException(nameof(UserHandle));
        }
        unsafe {
            ...
            var __returnValueSurface =
              new Discord.Sdk.UserApplicationProfileHandle[(int)__returnValue.size];
            for (int __i = 0; __i < (int)__returnValue.size; __i++) {
...
public class Client : IDisposable {
    ...
    public void RegisterAuthorizeRequestCallback(
      Discord.Sdk.Client.AuthorizeRequestCallback callback) {
        if (disposed_ != 0) {
            throw new ObjectDisposedException(nameof(Client));
        }
        unsafe {
            Discord.Sdk.NativeMethods.Client.AuthorizeRequestCallback __callbackDelegate =
              Discord.Sdk.NativeMethods.Client.AuthorizeRequestCallback_Handler;
            fixed(NativeMethods.Client* self = &this.self) {
    ...
    ///
    /// </remarks>
    public void IsDiscordAppInstalled(Discord.Sdk.Client.IsDiscordAppInstalledCallback callback) {
        if (disposed_ != 0) {
            throw new ObjectDisposedException(nameof(Client));
        }
        unsafe {
            Discord.Sdk.NativeMethods.Client.IsDiscordAppInstalledCallback __callbackDelegate =
              Discord.Sdk.NativeMethods.Client.IsDiscordAppInstalledCallback_Handler;
            fixed(NativeMethods.Client* self = &this.self) {
